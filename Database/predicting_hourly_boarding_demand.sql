...
--
-- Host: localhost
-- Generation Time: Jul 26, 2023 at 12:35 PM
...
--
-- Database: `predicting_hourly_boarding_demand`
--
CREATE DATABASE IF NOT EXISTS `predicting_hourly_boarding_demand` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `predicting_hourly_boarding_demand`;
...
('jcg1t91q6ubj6wik64hkp0dqw01fa18x', 'eyJ1c2VyaWQiOjJ9:1qOdf7:3nJK-IpZSIYF9wI6K5ADYukmh797VqjfMG-LfzkTNpE', '2023-08-09 12:30:41.750030'),
...
('wyx55nab3hh0a4nwnkji5iupwz79raky', 'eyJ1c2VyaWQiOjF9:1qOd5A:vVXX7O9HXwuUKa_GpHxv6FySeuVfKoRjNSKKs7mEZQY', '2023-08-09 11:53:32.116503'),
...
(19, 'Deep Neural Network-DNN', '48.81516587677725'),
(20, 'SVM', '46.44549763033176'),
(21, 'Logistic Regression', '49.763033175355446'),
(22, 'Gradient Boosting Classifier', '47.867298578199055');
...
--
-- Table structure for table `remote_user_prediction_bus_boarding`
--

CREATE TABLE IF NOT EXISTS `remote_user_prediction_bus_boarding` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `TripID` varchar(300) NOT NULL,
  `RouteID` varchar(300) NOT NULL,
  `StopID` varchar(300) NOT NULL,
  `StopName` varchar(300) NOT NULL,
  `WeekBeginning` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_prediction_bus_boarding`
--

INSERT INTO `remote_user_prediction_bus_boarding` (`id`, `Fid`, `TripID`, `RouteID`, `StopID`, `StopName`, `WeekBeginning`, `NumberOfBoardings`, `Prediction`) VALUES
(1, '172.217.6.206-10.42.0.151-80-36951-6', '44687', '700', '72527', '279 Woodville Rd', '30-06-2022  72:00:00 AM', '6', 'Less Demand'),
(2, '10.42.0.211-66.198.24.224-60502-443-6', '44687', '700', '72947', '77  Grange Rd', '30-06-2022  72:00:00 AM', '17', 'More Demand'),
(3, '10.42.0.211-23.21.51.186-39524-443-6', '44687', '700', '73337', '9A  Holbrooks Rd', '30-06-2022  72:00:00 AM', '6', 'Less Demand'),
(4, '202.77.129.150-10.42.0.211-443-48308-6', '44697', '700', '73375', '207 Marion Rd', '30-06-2022  72:00:00 AM', '3', 'Less Demand');
